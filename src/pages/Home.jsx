        ...
        <div className="grid gap-0 md:grid-cols-[1.15fr_0.85fr]">
          <div className="p-5 sm:p-8">
            ...
            <h1 className="mt-3 max-w-3xl text-4xl font-black tracking-tight text-white sm:text-6xl">
              Decide what is worth watching, playing, and saving.
            </h1>
            <p className="mt-4 max-w-2xl text-base leading-7 text-neutral-400 sm:text-lg">
              Collect recommendations, vote through the pile, and keep track of the favorites your group comes back to.
            </p>
          ...
          <div className="relative min-h-[320px] bg-neutral-900">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-5">
              <p className="text-xs uppercase tracking-[0.3em] text-neutral-300">Top movie</p>
              <h2 className="mt-2 text-3xl font-black text-white">{topMovie.title}</h2>
              <p className="mt-2 text-sm text-neutral-300">{topMovie.picks} picks · score {topMovie.score}</p>
            </div>
          </div>
        </div>
      </section>
