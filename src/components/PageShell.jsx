      ...
      <div className="mx-auto max-w-6xl">
        <div className="fixed right-4 top-4 z-[90] flex items-center gap-2 lg:right-6 lg:top-6">
          <Link
            ...
            className={`inline-flex rounded-full border px-4 py-2 text-xs font-black uppercase tracking-[0.16em] shadow-2xl shadow-black/30 transition ${communityActive ? 'border-white bg-white text-neutral-950' : 'border-white/10 bg-neutral-950/90 text-white hover:bg-white hover:text-neutral-950'}`}
          >
            Community
          </Link>
          <NotificationCenter />
