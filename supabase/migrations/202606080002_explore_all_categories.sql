...
-- All UNION branches cast released/year-like fields consistently so Supabase SQL editor can run it safely.
...
media as (
  ...
  select
    ...
    'series'::text as icon,
    s.series_id::text as item_id,
    s.title::text as title,
    s.year::text as year,
    s.released::text as released,
    s.poster::text as poster,
    s.backdrop::text as backdrop,
    s.overview::text as overview,
    s.tmdb_rating::numeric as tmdb_rating,
    null::numeric as rawg_rating,
    s.runtime::integer as runtime,
    s.genres::text[] as genres,
    s.seasons::integer as seasons,
    s.episodes::integer as episodes,
    null::text as platform,
    '{}'::text[] as platforms,
    null::text as director,
    s.nominated_by::text as nominated_by,
  ...
  select
    ...
    'games'::text as icon,
    ga.game_id::text as item_id,
    ga.title::text as title,
    ga.year::text as year,
    ga.released::text as released,
    ga.poster::text as poster,
    ga.backdrop::text as backdrop,
    ga.overview::text as overview,
    null::numeric as tmdb_rating,
    ga.rawg_rating::numeric as rawg_rating,
    null::integer as runtime,
    ga.genres::text[] as genres,
    null::integer as seasons,
    null::integer as episodes,
    ga.platform::text as platform,
    ga.platforms::text[] as platforms,
    null::text as director,
    ga.nominated_by::text as nominated_by,
  ...
  select
    ...
    'videos'::text as icon,
    v.video_id::text as item_id,
    v.title::text as title,
    v.year::text as year,
    null::text as released,
    v.poster::text as poster,
    v.backdrop::text as backdrop,
    coalesce(v.overview, v.url)::text as overview,
    null::numeric as tmdb_rating,
    null::numeric as rawg_rating,
    null::integer as runtime,
    '{}'::text[] as genres,
    ...
    '{}'::text[] as platforms,
    null::text as director,
    v.nominated_by::text as nominated_by,
  ...
  select
    ...
    mi.title::text as title,
    null::text as year,
    null::text as released,
    mi.poster::text as poster,
    mi.poster::text as backdrop,
    concat_ws(' · ', nullif(mi.artist, ''), nullif(mi.album, ''), nullif(mi.source, ''), nullif(mi.url, ''))::text as overview,
    null::numeric as tmdb_rating,
    null::numeric as rawg_rating,
    null::integer as runtime,
    ...
    null::integer as seasons,
    null::integer as episodes,
    coalesce(mi.source, mi.item_type)::text as platform,
    array_remove(array[mi.source, mi.item_type], null)::text[] as platforms,
    null::text as director,
    mi.nominated_by::text as nominated_by,
    0::integer as score,
    0::integer as picks,
    null::numeric as rating,
  ...
  select
    ...
    bi.title::text as title,
    bi.year::text as year,
    null::text as released,
    bi.poster::text as poster,
    bi.poster::text as backdrop,
    bi.overview::text as overview,
    null::numeric as tmdb_rating,
    null::numeric as rawg_rating,
    null::integer as runtime,
    ...
    null::integer as seasons,
    null::integer as episodes,
    coalesce(bi.source, bi.reading_status)::text as platform,
    array_remove(array[bi.source, bi.reading_status, bi.age_band], null)::text[] as platforms,
    array_to_string(bi.authors, ', ')::text as director,
    bi.nominated_by::text as nominated_by,
    0::integer as score,
    0::integer as picks,
    null::numeric as rating,
